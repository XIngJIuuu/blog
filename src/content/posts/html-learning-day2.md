...
> [!NOTE]
> 这是第二天 HTML 学习笔记，重点补充排版标签、文本样式、图片路径和超链接的常用属性，同样整理自入门练习。
...
绝对路径也可以直接写成完整的网络 URL：

```html
<img src="https://example.com/images/pic.jpg" alt="橙色千咲">
```

> 以盘符开头的本地绝对路径只在自己电脑上有效，发布到网站后别人无法访问，图片会直接裂图。实际项目中图片一般放在网站目录内，使用相对路径或网络 URL。
